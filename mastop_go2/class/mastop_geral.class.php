...
### www.mastop.com.br
### =============================================================
### $Id: mastop_geral.class.php 10037 2012-08-08 11:35:43Z beckmi $
### =============================================================
...
<tr><td class="outer" style="background-color: #F3F2F2;"><div style="text-align: center;">';
            ...
            foreach ($campos['rotulo'] as $k => $v) {
                $ret .= "<td nowrap='nowrap' align='center' ".(($sort == $campos['nome'][$k] && empty($campos['nosort'][$k])) ? "class='hds'" : '').">".((empty($campos['nosort'][$k])) ? "<A HREF='".$url_colunas."&sort=".$campos['nome'][$k]."&order=".$norder."'>".$v." ".(($sort == $campos['nome'][$k]) ? "<img src=" .$pathIcon16 .'/'. $order.".png align='absmiddle'>" : '')."</a></td>" : $v."</td>");
            }
