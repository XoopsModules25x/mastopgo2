...
### www.mastop.com.br
### =============================================================
### $Id: formimage.php 12503 2014-04-25 15:02:18Z beckmi $
### =============================================================
...
class MastopFormSelectImage extends XoopsFormSelect {
  ...
  */
  ...
  function render() {
    ...
    $ret = "<select onchange='if (this.options[this.selectedIndex].value != \"\") { document.getElementById(\"".$this->getName()."_img\").src=\"".XOOPS_URL."\"+this.options[this.selectedIndex].value;} else {document.getElementById(\"".$this->getName()."_img\").src=\"".XOOPS_URL."/modules/".MGO_MOD_DIR."/assets/images/spager.gif\";}'  size='".$this->getSize()."'".$this->getExtra()."";
