 ...
 */
function xoops_module_pre_update_mastopgo2(XoopsModule $module)
{
...
function xoops_module_update_mastopgo2(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Mastopgo2\Helper $helper */
    /** @var Mastopgo2\Utility $utility */
    /** @var Mastopgo2\Configurator $configurator */
    $helper  = Mastopgo2\Helper::getInstance();
    $utility = new Mastopgo2\Utility();
    $configurator = new Mastopgo2\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'mastopgo2x_categories';
        $column     = 'ordre';
        $newName    = 'order';
